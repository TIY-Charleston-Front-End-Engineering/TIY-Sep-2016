...
var getCounts = function( strOfText ){
   ...
   for (var i = 0 ; i < arrOfWords.length ; i++){
      ...
      //if( wordCountObject[theWord] ){...}
      if( typeof wordCountObject[theWord] === 'undefined'  ){
         wordCountObject[theWord] = 1

      } else {
         //ELSE the word isn't found on the wordCountObject:
   ...
   //OUTPUT: Object --  wordCount directory e.g. { the: 80, soup: 4  }
   //  {
   //    «word» : «integer (count)»
   //  }
}
